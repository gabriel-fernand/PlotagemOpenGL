    ...
    public partial class Tela_Plotagem : Form
    {
        ...
        public void falsoClick()
        {
            ...
            /*
                ...
                keyChecker.NumPad0 += () =>
                {
                    var enterKeyEvent = new KeyEventArgs(Keys.F10); // '\0' representa o Enter
                    TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                };
                keyChecker.D0 += () =>
                {
                ...
                keyChecker.NumPad5 += () =>
                {
                    var enterKeyEvent = new KeyEventArgs(Keys.F5); // '\0' representa o Enter
                    TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                };
                keyChecker.D5 += () =>
                {
                ...
                keyChecker.NumPad1 += () =>
                {
                    if (adInf == "A" || adInf == "I")
                    {
                        var enterKeyEvent = new KeyEventArgs(Keys.F1); // '\0' representa o Enter
                        TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                    }
                };
                keyChecker.D1 += () =>
                ...
                keyChecker.NumPad2 += () =>
                {
                    if (adInf == "A" || adInf == "I")
                    {
                        var enterKeyEvent = new KeyEventArgs(Keys.F2); // '\0' representa o Enter
                        TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                    }
                };
                keyChecker.D2 += () =>
                ...
                keyChecker.NumPad3 += () =>
                {
                    if (adInf == "A" || adInf == "I")
                    {
                        var enterKeyEvent = new KeyEventArgs(Keys.F3); // '\0' representa o Enter
                        TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                    }
                };
                keyChecker.D3 += () =>
                ...
                keyChecker.N += () =>
                {
                    ...
                    {
                        var enterKeyEvent = new KeyEventArgs(Keys.F4); // '\0' representa o Enter
                        TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                    }
                ...
                keyChecker.T += () =>
                {
                    if (AdInf.Equals("B") || AdInf.Equals("B") || AdInf.Equals("I"))
                    {
                        var enterKeyEvent = new KeyEventArgs(Keys.F6); // '\0' representa o Enter
                        TelaPlotagem_KeyDown(openglControl1, enterKeyEvent);
                    }
                };
            */
        ...
        async void MarcaEstagio(int est)
        {
            ...
            if (GlobVar.segundos == 30)
            {
                ...
                double inteiro = (double)Math.Floor((double)((GlobVar.indice / GlobVar.namos) / 30));
                double fracionario = (double)((double)(GlobVar.indice / GlobVar.namos) / 30) - inteiro;
                fracionario = fracionario <= 0.4 ? inteiro : inteiro + 1;

                int paginaCoerente = (int)fracionario * 30;

                if (paginaCoerente >= 0)
                {
                    int limite = Math.Min(paginaCoerente + 30, GlobVar.tbl_Paginas.Rows.Count);
        ...
        //private void TelaPlotagem_KeyDown()
        {
            try
            {
                ...
                if ((isAnEvent || isAnEndEvent || isAnStartEvent) && !isDrawing)
                {
                    if (e.KeyValue == 46)
                    {
                        plotEventos.DeleteEvent(GlobVar.iniEventoMove, GlobVar.durEventoMove, GlobVar.CodCanalEvent, GlobVar.desenhoLoc, GlobVar.startY, GlobVar.seqEvento, GlobVar.CodEvento);
                        ...
                        case Keys.D:
                            if (GlobVar.maximaVect <= GlobVar.matrizCanal.GetLength(1))
                            {
                                ...
                                */
                                if (GlobVar.indice > 0)
                                {
                                    int newLoc = GlobVar.indice + GlobVar.namos;
                                    int newLocNum = GlobVar.indiceNumero + GlobVar.namosNumerico;
                                    if (!conc)
                                    {
                                        if (newLoc > GlobVar.areaCarregadaAltMont || newLoc < GlobVar.indice)
                                        {
                                    ...
                                    if (GlobVar.indice > 0)
                                    {
                                        int vezesAndar = (Convert.ToInt32(segundosI) < GlobVar.segundos) ? Math.Abs((Convert.ToInt32(segundosI) - GlobVar.segundos)) : (Convert.ToInt32(segundosI) > GlobVar.segundos) ? Math.Abs(Math.Abs((Convert.ToInt32(segundosI) - GlobVar.segundos)) - GlobVar.segundos) : GlobVar.segundos - 1;
                            ...
                            break;
                        case Keys.PageDown:
                            if (GlobVar.indice > 0 && GlobVar.maximaVect <= GlobVar.matrizCanal.GetLength(1))
                            {
                                int newLoc = GlobVar.indice + GlobVar.namos;
                                int newLocNum = GlobVar.indiceNumero + GlobVar.namosNumerico;
                                if (!conc)
                                ...
                                if (GlobVar.indice > 0)
                                {
                                    ...
                                    if (Convert.ToInt32(segundosI) != 30 && Convert.ToInt32(segundosI) != 0)
                                    {
                                        if (GlobVar.indice > 0)
                                        {
                                            ...
                                            GlobVar.ponteiroVideo = GlobVar.indice - ((GlobVar.segundos * 512) / 2);
                                            if (hScrollBar1.InvokeRequired)
                                            {
                                                hScrollBar1.Invoke(new Action(() =>
                                                {
        ...
        public async void UpdateInicioTela()
        {
            ...
            if (GlobVar.segundos == 30 )//&& (segI == 30 || segI == 0))
            {
                ...
                UmaProxima.BackColor = System.Drawing.Color.LimeGreen; ; UmaProxima.Enabled = true;
                DuasProxima.BackColor = System.Drawing.Color.LimeGreen; DuasProxima.Enabled = true;
                TresProxima.BackColor = System.Drawing.Color.LimeGreen; TresProxima.Enabled = true;
                QuatroProxima.BackColor = System.Drawing.Color.LimeGreen; QuatroProxima.Enabled = true;
            ...
            else
            {
                ...
                if(GlobVar.segundos == 60)   { UmaProxima.BackColor = System.Drawing.Color.Orange; DuasProxima.BackColor = System.Drawing.Color.LimeGreen; TresProxima.BackColor = System.Drawing.Color.LimeGreen; QuatroProxima.BackColor = System.Drawing.Color.LimeGreen; }
                if (GlobVar.segundos == 90)  { UmaProxima.BackColor = System.Drawing.Color.Orange; DuasProxima.BackColor = System.Drawing.Color.Orange; TresProxima.BackColor = System.Drawing.Color.LimeGreen; QuatroProxima.BackColor = System.Drawing.Color.LimeGreen; }
                if (GlobVar.segundos == 120) { UmaProxima.BackColor = System.Drawing.Color.Orange; DuasProxima.BackColor = System.Drawing.Color.Orange; TresProxima.BackColor = System.Drawing.Color.Orange; QuatroProxima.BackColor = System.Drawing.Color.LimeGreen; }
                if (GlobVar.segundos == 240) { UmaProxima.BackColor = System.Drawing.Color.Orange; DuasProxima.BackColor = System.Drawing.Color.Orange; TresProxima.BackColor = System.Drawing.Color.Orange; QuatroProxima.BackColor = System.Drawing.Color.Orange; }
        ...
        /// </summary>
        private async void UpdateGlobVarStates()
        {
            if (GlobVar.indice > 0)
            {
                int newLoc = GlobVar.indice + GlobVar.namos;
        ...
        public static int CustomRound(double valor, double threshold = 0.4)
        {
            int inteiro = (int)Math.Floor(valor);
            double fracionario = valor - inteiro;
            return fracionario <= threshold ? inteiro : inteiro + 1;
        }
        /// <summary>
        ...
        private void AlterarRef_Click(object sender, EventArgs e)
        {
            ...
            GlobVar.matrizCanal.SetRow<float>(
                GlobVar.codSelected.IndexOf(codCanal1),
                LeituraEmMatrizTeste.FloatToShort(LeituraEmMatrizTeste.SetReferencia(codCanal1, novoCodCanal2)));
            ...
            if (rowNumerico["PassaBaixa"] != DBNull.Value || rowNumerico["PassaAlta"] != DBNull.Value || rowNumerico["Notch"] != DBNull.Value)
            {
                ...
                if (hertzSelectHigh == 0)
                {
                    ...
                    else
                    {
                        ...
                        GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])),
                        (PaissaBaixa.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])))), (float)hertzSelect, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[Tela_Plotagem.index])])));
                    }
                }
                else
                {
                    ...
                    {
                        GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])),
                            (PaissaAlta.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])))), (float)hertzSelectHigh, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[Tela_Plotagem.index])])));
                    ...
                    else
                    {
                        hertzSelect = Convert.ToInt32(rowNumerico["PassaBaixa"]);
                        GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])),
                       (BandPass.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])))),
                        (float)hertzSelect,
                ...
                if (rowNumerico["Notch"] != DBNull.Value)
                {
                    ...
                    GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])),
                    (Notch.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(rowNumerico["CodCanal1"])))),
                        (float)NotchHertz,
                        10,
                ...
                if (clickedPanel is Panel panel)
                {
                    ...
                    if (panelLowFilterStates.ContainsKey(panel) && ContainsFilter(panelLowFilterStates, clickedItem.Name))
                    {
                                        ...
                                        using (var inputForm = new InputForm("Insira o valor para o filtro"))
                                        {
                                            if (inputForm.ShowDialog() == DialogResult.OK)
                                            {
                                                ...
                                                if (float.TryParse(inputValue, out float hertzSelect))
                                                {
                                                    ...
                                                    GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                                    (PaissaBaixa.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelect, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                                                    openglControl1.DoRender();
                                                    plotagem.DesenhaGrafico((int)openglControl1.Height, qtdGrafics);
                                                }
                                                else
                            ...
                            else if (value.Equals("outroHighGl"))
                            {
                                ...
                                if (clickedItem.CheckOnClick == true)
                                {
                                    ...
                                    if (clickedItem.Text.Equals("Nenhum"))
                                    {
                                        ...
                                        GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                            (PaissaAlta.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelectH, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                                        ...
                                        using (var inputForm = new InputForm("Insira o valor para o filtro"))
                                        {
                                            if (inputForm.ShowDialog() == DialogResult.OK)
                                            {
                                                ...
                                                if (float.TryParse(inputValue, out float hertzSelect))
                                                {
                                                    GlobVar.tbl_MontagemSelecionada.Rows[index]["PassaBaixa"] = hertzSelect;
                                                    GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                                    (BandPass.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelect, (float)hertzSelectH, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                                                    openglControl1.DoRender();
                                                    plotagem.DesenhaGrafico((int)openglControl1.Height, qtdGrafics);
                                                }
                                                else
                        ...
                        if (GlobVar.tbl_MontagemSelecionada.Rows[index]["Notch"] != DBNull.Value)
                        {
                            ...
                            GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                (Notch.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))),
                                NotchHertz,
                                10,
                                        ...
                                        using (var inputForm = new InputForm("Insira o valor para o filtro"))
                                        {
                                            if (inputForm.ShowDialog() == DialogResult.OK)
                                            {
                                                ...
                                                if (float.TryParse(inputValue, out float hertzSelect))
                                                {
                                                    ...
                                                    GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                                        (PaissaAlta.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelect, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                            ...
                            else if (value.Equals("OutroLowGl"))
                            {
                                ...
                                if (clickedItem.CheckOnClick == true)
                                {
                                    ...
                                    if (clickedItem.Text.Equals("Nenhum"))
                                    {
                                        GlobVar.tbl_MontagemSelecionada.Rows[index]["PassaAlta"] = DBNull.Value;
                                        GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                            (PaissaBaixa.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelectL, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                                        ...
                                        using (var inputForm = new InputForm("Insira o valor para o filtro"))
                                        {
                                            if (inputForm.ShowDialog() == DialogResult.OK)
                                            {
                                                ...
                                                if (float.TryParse(inputValue, out float hertzSelect))
                                                {
                                                    GlobVar.tbl_MontagemSelecionada.Rows[index]["PassaAlta"] = hertzSelect;
                                                    GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                                        (BandPass.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelectL, (float)hertzSelect, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                    ...
                    else if (panelNotchFilterStates.ContainsKey(panel) && ContainsFilter(panelNotchFilterStates, clickedItem.Name))
                    {
                                    ...
                                    using (var inputForm = new InputForm("Insira o valor para o filtro"))
                                    {
                                        if (inputForm.ShowDialog() == DialogResult.OK)
                                        {
                                            ...
                                            if (float.TryParse(inputValue, out float hertzSelect))
                                            {
                                                ...
                                                GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                                (Notch.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelect, 10, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                                                openglControl1.DoRender();
                                                plotagem.DesenhaGrafico((int)openglControl1.Height, qtdGrafics);
                                            }
                                            else
                        ...
                        else if (hertzSelectLow != 0 && hertzSelectHigh == 0)
                        {
                            if (clickedItem.CheckOnClick == true)
                            {
                                ...
                                filtrosSinais.VoltaMatriz((short)GlobVar.codSelected[selec]);
                                GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                    (PaissaBaixa.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelectLow, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                        ...
                        else if (hertzSelectLow == 0 && hertzSelectHigh != 0)
                        {
                            if (clickedItem.CheckOnClick == true)
                            {
                                ...
                                filtrosSinais.VoltaMatriz((short)GlobVar.codSelected[selec]);
                                GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                    (PaissaAlta.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelectHigh, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
                        ...
                        else
                        {
                            if (clickedItem.CheckOnClick == true)
                            {
                                ...
                                filtrosSinais.VoltaMatriz((short)GlobVar.codSelected[selec]);
                                GlobVar.matrizCanal.SetRow<float>(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])),
                                    (BandPass.ApplyFilter((GlobVar.matrizCanal.GetRow(GlobVar.codSelected.IndexOf(Convert.ToInt32(GlobVar.tbl_MontagemSelecionada.Rows[index]["CodCanal1"])))), (float)hertzSelectLow, (float)hertzSelectHigh, GlobVar.txPorCanal[GlobVar.codCanal.IndexOf(GlobVar.codSelected[index])])));
